 ...
 */
const variants = {
    primary: "bg-zinc-800 text-zinc-950 border border-zinc-100 hover:bg-white active:bg-zinc-200",
    ...
    ghost: "bg-zinc-800 text-zinc-400 hover:text-zinc-100 hover:bg-zinc-800",
    none: ""
}
